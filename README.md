...
I'm a postgraduate student at Information Retrieval Laboratory at Shandong University, supervised by [Zhumin Chen](http://ir.sdu.edu.cn/~zhuminchen/~zhuminchen_en.htm) and [Pengjie Ren](https://pengjieren.github.io/). 
...
### Publications
* **Chuan Meng**, Pengjie Ren, Zhumin Chen, Weiwei Sun, Zhaochun Ren, Zhaopeng Tu and Maarten de Rijke. **DukeNet: A Dual Knowledge Interaction Network for Knowledge-Grounded Conversation**. The 43rd International ACM SIGIR Conference on Research and Development in Information Retrieval (**SIGIR**), Xian, July 25-30, 2020. (CCF A) [[pdf]](https://dl.acm.org/doi/pdf/10.1145/3397271.3401097) [[code]](https://github.com/ChuanMeng/DukeNet)
