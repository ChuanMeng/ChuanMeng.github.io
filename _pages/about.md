...
2. **Bridging the Gap: From Ad-hoc to Proactive Search in Conversations**       
   ...
   **SIGIR 2025**: The 48th International ACM SIGIR Conference on Research and Development in Information Retrieval       
   [[pdf]](https://chuanmeng.github.io/files/papers/conv2query_sigir2025_full.pdf) [[code]](https://github.com/ChuanMeng/Conv2Query)               
3. **Query Performance Prediction using Relevance Judgments Generated by Large Language Models**       
   ...
   **TOIS**: ACM Transactions on Information Systems    
   [[pdf]](https://dl.acm.org/doi/pdf/10.1145/3736402) [[code]](https://github.com/ChuanMeng/QPP-GenRE)  
