...
As of July 2024, I have 205 citations (Google Scholar) with an H-index of 6.

I have authored papers published in proceedings, such as SIGIR, EMNLP, CIKM, and AAAI. 
1. Arian Askari<sup>#</sup>, **Chuan Meng<sup>#</sup>(co-first author)**, Mohammad Aliannejadi, Zhaochun Ren, Evangelos Kanoulas, and Suzan Verberne. **Expand, Highlight, Generate: RL-driven Document Generation for Passage Reranking**. Under review for The 2024 Conference on Empirical Methods in Natural Language Processing (**EMNLP 2024**). [[pdf]](https://chuanmeng.github.io/files/papers/fewshotgr.pdf) 
