...
1. Arian Askari<sup>#</sup>, **Chuan Meng<sup>#</sup>(co-first author)**, Mohammad Aliannejadi, Zhaochun Ren, Evangelos Kanoulas, and Suzan Verberne. **Generative Retrieval with Few-shot Indexing**. Under review for The 2024 Conference on Empirical Methods in Natural Language Processing (**EMNLP 2024**). [[pdf]](https://chuanmeng.github.io/files/papers/fewshotgr.pdf) 
