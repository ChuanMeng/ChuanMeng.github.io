...
As of October 2024, I have 230 citations (Google Scholar) with an H-index of 7.
...
1. **Query Performance Prediction using Relevance Judgments Generated by Large Language Models**       
   ...
   **Under review for TOIS**: ACM Transactions on Information Systems      
...
8. **Expand, Highlight, Generate: RL-driven Document Generation for Passage Reranking**          
...
9. **System Initiative Prediction for Multi-turn Conversational Information Seeking**       
...
10. **Query Performance Prediction: From Ad-hoc to Conversational Search**      
...
11. **Performance Prediction for Conversational Search Using Perplexities of Query Rewrites**         
    **Chuan Meng**, Mohammad Aliannejadi, and Maarten de Rijke      
...
12. **Initiative-Aware Self-Supervised Learning for Knowledge-Grounded Conversations**      
...
13. **Conversations Powered by Cross-Lingual Knowledge**        
...
14. **DukeNet: A Dual Knowledge Interaction Network for Knowledge-Grounded Conversation**      
...
15. **RefNet: A Reference-aware Network for Background Based Conversation**        
...
* [System Initiative Prediction and Query Performance Prediction for Conversational Information Seeking](https://www.linkedin.com/posts/ucl-wi-group_ucl-wi-talk-system-initiative-and-query-activity-7124768037257256960-Gcp-/?utm_source=share&utm_medium=member_desktop)
...
* [Query Performance Prediction for Conversational Search](https://samoa.dcs.gla.ac.uk/events/viewtalk.jsp?id=18953)
