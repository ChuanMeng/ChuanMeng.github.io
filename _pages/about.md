...
I have published at venues such as ACL, EMNLP, NAACL, SIGIR, CIKM, AAAI, ECIR, and TOIS; according to the [ICORE 2026 conference ranking](https://portal.core.edu.au/conf-ranks/), **11** of my papers are at CORE A* venues (9 as first author) and **5** at CORE A venues; my journal articles are in ACM TOIS, rated Q1 in the [SCImago Journal Rank](https://www.scimagojr.com/journalsearch.php?q=18997&tip=sid).
...
4. **Toward Exploring Mixed-Initiative Conversation Generation Based on Community Question Answering**       
   ...
   **TOIS** <span style="color:#b22222">(SJR Q1)</span>: ACM Transactions on Information Systems, 44(5), 1--29, 2026       
...
5. **Generative Retrieval with Few-shot Indexing**       
   ...
   **ECIR 2026** <span style="color:#b22222">(CORE A)</span>: The 48th European Conference on Information Retrieval       
...
6. **Towards Adaptive Personalized Conversational Information Retrieval**       
   ...
   **CIKM 2025** <span style="color:#b22222">(CORE A)</span>: The 34th ACM International conference on Information and Knowledge Management           
...
7. **UniConv: Unifying Retrieval and Response Generation for Large Language Models in Conversations**       
   ...
   **ACL 2025** <span style="color:#b22222">(CORE A*)</span>: The 63rd Annual Meeting of the Association for Computational Linguistics            
...
8. **Bridging the Gap: From Ad-hoc to Proactive Search in Conversations**       
   ...
   **SIGIR 2025** <span style="color:#b22222">(CORE A*)</span>: The 48th International ACM SIGIR Conference on Research and Development in Information Retrieval       
...
9. **Query Performance Prediction using Relevance Judgments Generated by Large Language Models**       
   ...
   **TOIS** <span style="color:#b22222">(SJR Q1)</span>: ACM Transactions on Information Systems, 43(4), 1-35, 2025 (**Selected as one of five featured articles**)    
