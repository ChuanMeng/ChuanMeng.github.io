...
As of September 2026, I have 800+ citations (Google Scholar) with an H-index of 17.

I have published at venues such as ACL, EMNLP, NAACL, SIGIR, CIKM, AAAI, ECIR, and TOIS; according to the [ICORE 2026 conference ranking](https://portal.core.edu.au/conf-ranks/), **11** of my papers are at CORE A* venues (9 as first author) and **5** at CORE A venues.

1. **Revisiting Text Ranking in Deep Research**            
   **Chuan Meng**, Litu Ou, Sean MacAvaney, and Jeff Dalton         
   **SIGIR 2026** (CORE A*): The 49th International ACM SIGIR Conference on Research and Development in Information Retrieval                  
...
4. **Toward Exploring Mixed-Initiative Conversation Generation Based on Community Question Answering**       
...
5. **Generative Retrieval with Few-shot Indexing**       
   ...
   **ECIR 2026** (CORE A): The 48th European Conference on Information Retrieval       
   [[pdf]](https://arxiv.org/abs/2408.02152) 
6. **Towards Adaptive Personalized Conversational Information Retrieval**       
   Fengran Mo, Yuchen Hui, Yuxing Tian, Zhaoxuan Tan, **Chuan Meng**, Zhan Su, Kaiyu Huang, Jian-Yun Nie              
   **CIKM 2025** (CORE A): The 34th ACM International conference on Information and Knowledge Management           
   [[pdf]](https://dl.acm.org/doi/10.1145/3746252.3761255)                    
7. **UniConv: Unifying Retrieval and Response Generation for Large Language Models in Conversations**       
   ...
   **ACL 2025** (CORE A*): The 63rd Annual Meeting of the Association for Computational Linguistics            
   [[pdf]](https://aclanthology.org/2025.acl-long.344/)                 
8. **Bridging the Gap: From Ad-hoc to Proactive Search in Conversations**       
   **Chuan Meng**, Francesco Tonolini, Fengran Mo, Nikolaos Aletras, Emine Yilmaz, and Gabriella Kazai    
   **SIGIR 2025** (CORE A*): The 48th International ACM SIGIR Conference on Research and Development in Information Retrieval       
   [[pdf]](https://dl.acm.org/doi/10.1145/3726302.3729915) [[code]](https://github.com/ChuanMeng/Conv2Query)               
9. **Query Performance Prediction using Relevance Judgments Generated by Large Language Models**       
   **Chuan Meng**, Negar Arabzadeh, Arian Askari, Mohammad Aliannejadi, and Maarten de Rijke        
   **TOIS**: ACM Transactions on Information Systems, 43(4), 1-35, 2025 (**Selected as one of five featured articles**)    
   [[pdf]](https://dl.acm.org/doi/10.1145/3736402) [[code]](https://github.com/ChuanMeng/QPP-GenRE)  
10. **SOLID: Self-seeding and Multi-intent Self-instructing LLMs for Generating Intent-aware Information-Seeking Dialogs**       
...
11. **Zero-Shot and Efficient Clarification Need Prediction in Conversational Search**       
   Lili Lu, **Chuan Meng**, Federico Ravenda, Mohammad Aliannejadi, and Fabio Crestani       
    **ECIR 2025** (CORE A): The 47th European Conference on Information Retrieval    
   [[pdf]](https://link.springer.com/chapter/10.1007/978-3-031-88708-6_25) [[code]](https://github.com/lulili0963/Zef-CNP)    
12. **Improving the Re-Usability of Conversational Search Test Collections**         
...
14. **Query Performance Prediction for Conversational Search and Beyond**      
   **Chuan Meng**      
   **SIGIR 2024** (CORE A*): The 47th International ACM SIGIR Conference on Research and Development in Information Retrieval      
...
17. **Expand, Highlight, Generate: RL-driven Document Generation for Passage Reranking**          
   ...
   **EMNLP 2023** (CORE A*): The 2023 Conference on Empirical Methods in Natural Language Processing             
...
18. **System Initiative Prediction for Multi-turn Conversational Information Seeking**       
   ...
   **CIKM 2023** (CORE A): The 32nd ACM International Conference on Information and Knowledge Management      
...
19. **Query Performance Prediction: From Ad-hoc to Conversational Search**      
    ...
    **SIGIR 2023** (CORE A*): The 46th International ACM SIGIR Conference on Research and Development in Information Retrieval        
...
21. **Initiative-Aware Self-Supervised Learning for Knowledge-Grounded Conversations**      
    ...
    **SIGIR 2021** (CORE A*): The 44th International ACM SIGIR Conference on Research and Development in Information Retrieval      
...
23. **DukeNet: A Dual Knowledge Interaction Network for Knowledge-Grounded Conversation**      
    ...
    **SIGIR 2020** (CORE A*): The 43rd International ACM SIGIR Conference on Research and Development in Information Retrieval      
...
24. **RefNet: A Reference-aware Network for Background Based Conversation**        
    ...
    **AAAI 2020** (CORE A*): The Thirty-Fourth AAAI Conference on Artificial Intelligence      
...
* **The Role of Information Retrieval in Deep Research**        
  ...
  [[slides]](https://chuanmeng.github.io/files/slides/talk_ccir_16.8.2026.pdf)        
* **The Role of Information Retrieval in Deep Research**        
